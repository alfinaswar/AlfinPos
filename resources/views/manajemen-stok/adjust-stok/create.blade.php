        ...
        <div class="row">
            <div class="col">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Tambah Penyesuaian Stok</li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <form action="{{ route('so.store') }}" method="POST">
        ...
        <div class="card mb-4">
            <div class="card-header bg-dark">
                <h4 class="card-title mb-0">Formulir Penyesuaian Stok</h4>
                <p class="card-text mb-0">
                    Silakan isi data penyesuaian stok di bawah ini.
                </p>
            </div>
            <div class="card-body">
                <div class="row g-3 mb-4">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="Petugas" id="petugas"
                            ...
                            value="{{ old('Petugas', Auth::user()->name ?? '') }}" placeholder="Nama Petugas" readonly>
                        @error('Petugas')
                            <div class="text-danger mt-1">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <p class="mb-3">
                    Tambahkan produk yang ingin disesuaikan stoknya.
                </p>
