...
@section('content')
    ...
    <div class="row mb-3">
        <div class="col text-end">
            <a class="btn btn-primary" href="{{ route('bm.create') }}">Tambah Barang Masuk</a>
        </div>
    </div>
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header bg-dark">
                    ...
                    <p class="card-text">
                        Tabel ini menampilkan seluruh data barang masuk yang tersedia.
                    </p>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table datanew cell-border compact stripe" id="barangMasukTable" width="100%">
                            <thead>
                                <tr>
                                    <th width="5%">No</th>
                                    <th>Tanggal Masuk</th>
            ...
            $('body').on('click', '.btn-delete', function () {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: '{{ route('bm.destroy', ':id') }}'.replace(':id', id),
                            type: 'DELETE',
                            data: {
                                _token: '{{ csrf_token() }}'
                            },
