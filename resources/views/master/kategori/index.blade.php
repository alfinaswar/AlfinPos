...
@section('content')
    <div class="page-header">
        <div class="row">
            <div class="col">
                <h3 class="page-title">Master Kategori Produk</h3>
                <ul class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('home') }}">Dashboard</a></li>
                    <li class="breadcrumb-item active">Master Kategori Produk</li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="row mb-3">
        <div class="col text-end">
            <a class="btn btn-primary" href="{{ route('kategori.create') }}">Tambah Kategori Baru</a>
        </div>
    </div>
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header bg-dark">
                    ...
                    <p class="card-text">
                        Tabel ini menampilkan seluruh kategori produk yang tersedia.
                    </p>
                </div>
                <div class="card-body">
