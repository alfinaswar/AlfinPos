        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header bg-dark">
                    <h4 class="card-title mb-0">Formulir Edit Kategori</h4>
                    <p class="card-text mb-0">
                        Silakan ubah data kategori item di bawah ini.
                    </p>
                </div>
                <div class="card-body">
                            ...
                            <div class="col-md-12">
                                ...
                                <div id="drop-area" class="border border-2 border-dashed rounded p-3 text-center"
                                    ...
                                    <div class="mt-2 w-100 d-flex justify-content-center align-items-center"
                                        ...
                                        @if($kategori->Icon)
                                            <img id="icon-preview"
                                                src="{{ asset('storage/uploads/icon-kategori/' . $kategori->Icon) }}"
                                                alt="Preview Icon" style="display: block; max-height: 100px; margin: 0 auto;">
                                        @else
                                ...
                                @if($kategori->Icon)
                                    <div class="mt-2 text-center">
                                        ...
                                        <img src="{{ asset('storage/uploads/icon-kategori/' . $kategori->Icon) }}"
                                            alt="Icon Kategori" style="max-height: 60px;">
                                    </div>
                                @endif
                            </div>
    ...
    <script>
        ...
        function previewIcon(event) {
            ...
            if (input.files && input.files[0]) {
                ...
                // Jika tidak ada file baru, tampilkan icon lama jika ada
                @if($kategori->Icon)
                    preview.src = "{{ asset('storage/uploads/icon-kategori/' . $kategori->Icon) }}";
                    preview.style.display = 'block';
                @else
                    preview.src = '#';
