            ...
            <div class="card">
                <div class="card-header bg-dark">
                    ...
                    <p class="card-text mb-0">
                        Silakan ubah data produk di bawah ini.
                    </p>
                </div>
                <div class="card-body">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="Nama" class="form-control @error('Nama') is-invalid @enderror"
                                    id="nama" placeholder="Nama Produk" value="{{ old('Nama', $produk->Nama) }}">
                                @error('Nama')
                                    <div class="text-danger mt-1">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="KategoriItem" id="kategoriitem" onchange="getJenisItem(this.value)"
                                    ...
                                    @foreach ($KategoriItem as $kategori)
                                        <option value="{{ $kategori->id }}" {{ old('KategoriItem', $produk->KategoriItem) == $kategori->id ? 'selected' : '' }}>
                                            {{ $kategori->Nama }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="JenisItem" id="jenisitem"
                                    ...
                                    {{-- Opsi jenis item akan diisi via JS --}}
                                </select>
                                @error('JenisItem')
                                    <div class="text-danger mt-1">
                                        {{ $message }}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="HargaModal"
                                            ...
                                            value="{{ old('HargaModal', number_format($produk->HargaModal, 0, ',', '.')) }}">
                                    </div>
                                    @error('HargaModal')
                                        <div class="text-danger mt-1">
                                            {{ $message }}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="HargaJual"
                                            ...
                                            value="{{ old('HargaJual', number_format($produk->HargaJual, 0, ',', '.')) }}">
                                    </div>
                                    @error('HargaJual')
                                        <div class="text-danger mt-1">
                                            {{ $message }}
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="number" name="Stok" class="form-control @error('Stok') is-invalid @enderror"
                                    id="stok" placeholder="Stok" value="{{ old('Stok', $produk->Stok) }}">
                                @error('Stok')
                                    <div class="text-danger mt-1">
                                        {{ $message }}
                                    </div>
...
@push('js')
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            // Inisialisasi jenis item jika edit
            let kategoriId = document.getElementById('kategoriitem').value;
            let selectedJenis = "{{ old('JenisItem', $produk->JenisItem) }}";
            if (kategoriId) {
                getJenisItem(kategoriId, selectedJenis);
            }
        });
