...
@push('js')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Inisialisasi select2 pada load
            if (typeof $ !== 'undefined' && $.fn.select2) {
                $('.select2').select2();
            }
        });
    ...
    <script>
        ...
        // Auto-load jenis item jika edit
        document.addEventListener('DOMContentLoaded', function() {
            var kategoriId = document.getElementById('kategoriitem').value;
            var selectedJenis = "{{ old('JenisItem', $produk->JenisItem) }}";
            if (kategoriId) {
