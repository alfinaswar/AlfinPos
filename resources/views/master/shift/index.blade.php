...
@section('content')
    ...
    <div class="row mb-3">
        <div class="col text-end">
            <a class="btn btn-primary" href="{{ route('shift.create') }}">Tambah Shift Baru</a>
        </div>
    </div>
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header bg-dark">
                    ...
                    <p class="card-text">
                        Tabel ini menampilkan seluruh data shift yang tersedia.
                    </p>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table datanew cell-border compact stripe" id="shiftTable" width="100%">
                            <thead>
                                <tr>
                                    <th width="5%">No</th>
                                    <th>Nama Shift</th>
