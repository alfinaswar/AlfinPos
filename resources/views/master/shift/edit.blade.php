...
@section('content')
    <div class="page-header">
        <div class="row">
            <div class="col">
                <h3 class="page-title">Master Shift</h3>
                <ul class="breadcrumb">
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header bg-dark">
                    <h4 class="card-title mb-0">Formulir Edit Shift</h4>
                    <p class="card-text mb-0">
                        Silakan isi data shift yang ingin diedit di bawah ini.
                    </p>
                </div>
                <div class="card-body">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="text" name="NamaShift"
                                    ...
                                    placeholder="Nama Shift" value="{{ old('NamaShift', $shift->NamaShift) }}">
                                @error('NamaShift')
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="time" name="JamMasuk"
                                    ...
                                    value="{{ old('JamMasuk', $shift->JamMasuk) }}">
                                @error('JamMasuk')
                                    <div class="text-danger mt-1">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="time" name="JamPulang"
                                    ...
                                    value="{{ old('JamPulang', $shift->JamPulang) }}">
                                @error('JamPulang')
                                    <div class="text-danger mt-1">
                                        {{ $message }}
                                    </div>
